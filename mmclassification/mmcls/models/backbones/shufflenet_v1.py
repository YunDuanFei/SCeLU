...
class ShuffleUnit(BaseModule):
    ...
    def __init__(self,
        ...
        self.g_conv_1x1_expand = ConvModule(
            ...
            norm_cfg=norm_cfg,
            act_cfg=None)
        self.act_in_channels = self.bottleneck_channels if self.first_block else self.in_channels+self.out_channels
        self.act = build_activation_layer(act_cfg, self.act_in_channels)
