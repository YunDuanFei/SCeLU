...
def train(trainloader, net, criterion, optimizer, use_cuda=True):
    ...
    if isinstance(criterion, nn.CrossEntropyLoss):
        batch_pbar = tqdm(trainloader, leave=False, desc='Processing train batchs', colour='green')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_epoch', default=100, type=int, help='save every save_epochs')
    ...
    # model parameters
    parser.add_argument('--model', '-m', default='resnet20_relu')
    ...
    parser.add_argument('--trainloader', default='', help='path to the cifar_dataloader with random labels')
    ...
    trainloader, testloader = cifar_dataloader.get_data_loaders(args)
